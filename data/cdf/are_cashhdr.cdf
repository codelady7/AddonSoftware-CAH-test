...
rem --- also delete are-21 (are_cashgl)
...
delete_cashgl:
rem ==================================================================
rem --- called from above delete_cashdet_cashbal routine
rem ---    and AABO, since user may opt to exit/abort w/o saving a cash receipt, but after having created a cashgl rec 
