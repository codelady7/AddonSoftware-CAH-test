...
rem --- Inventory Item/Whse Lookup
	...
	filter_defs$[2,1]="='"+callpoint!.getColumnData("SFE_WOMATHDR.WAREHOUSE_ID")+"'"
	filter_defs$[2,2]=""
	...
	if cvs(ivmItemWhse_key$,2)<>"" and ivmItemWhse_key.item_id$<>callpoint!.getColumnData("SFE_WOMATDTL.ITEM_ID") then 
		callpoint!.setColumnData("SFE_WOMATDTL.ITEM_ID",ivmItemWhse_key.item_id$,1)
		callpoint!.setStatus("MODIFIED")
		callpoint!.setFocus(num(callpoint!.getValidationRow()),"SFE_WOMATDTL.ITEM_ID",1)
	endif
