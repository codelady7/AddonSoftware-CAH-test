...
rem --- Build SQL statement
	...
	sql_prep$=sql_prep$+"left join apc_typecode on apm_vendhist.firm_id = apc_typecode.firm_id and apc_typecode.record_id_a='A' and apm_vendhist.ap_type = apc_typecode.ap_type "
	sql_prep$=sql_prep$+"left join apc_distribution on apm_vendhist.firm_id=apc_distribution.firm_id and apc_distribution.record_id_b='B' and apm_vendhist.ap_dist_code=apc_distribution.ap_dist_code "
